...
SYSTEM_PROMPT = (
    ...
    "The OCR text, the related notes from earlier in this course, and any inline term "
    ...
    "weigh both and choose the most likely meaning.\n"
    ...
    "contents of any figure, diagram, chart, circuit, plot, or drawing. Emit a "
    "single placeholder in its place — a `paragraph` block whose text is exactly "
    "\"[figure]\" — and transcribe any surrounding handwritten text normally. Never "
    "turn a figure's contents into a list, paragraph, or equation.\n"
